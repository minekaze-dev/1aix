    ...
    return (
        <div className="flex gap-8 animate-in fade-in duration-700">
            <aside className="w-[240px] flex-shrink-0 space-y-10 hidden lg:block">
                ...
                {/* Artikel Populer Sidebar - Compact Version with Thumbnails */}
                <div>
                    <div className="flex items-center gap-3 mb-1">
                        ...
                        {popularArticles.map((art) => (
                            ...
                            >
                                <div className="flex gap-3 items-start">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <h4 className="text-[10px] font-black text-zinc-700 uppercase tracking-tight leading-tight group-hover:text-blue-600 transition-colors line-clamp-2 italic mb-1.5">
                                            {art.title}
                                        </h4>
                                        <div className="flex items-center gap-1.5 text-zinc-300">
                                            <ChatAlt2Icon className="w-2.5 h-2.5" strokeWidth={3} />
                                            <span className="text-[9px] font-black">{articleCommentCounts[art.id] || 0}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
